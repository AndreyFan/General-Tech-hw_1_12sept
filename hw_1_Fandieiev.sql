...
select * from staff;  -- проверка создания 

-- 3. Добавить 5 строк.

insert into staff(firstname,lastname,position, age, has_child,username) 
       value("John","Johnson","manager",65,"N","JJ65");    

insert into staff(firstname,lastname,position, age, has_child,username) 
       value("Max","maxon","worker",19,"N","Maxon2000"),
            ("Olga","Zepter","worker",32,"Y","SuperOlga"),
            ("Nil","Nilson","worker",42,"N","Nil_best"),
            ("Peter","Petroff","engineer",53,"Y","Petroff_P");
...
use tasks; --  переключаемся на работу с этой БД
...
select * from Staff; -- проверяем создание и заполнение таблицы
